...
;(function(window, document) {
  ...
  // document.body.style.display = 'none';   -zy 1125
  ...
  // linkEl.rel = 'stylesheet';
  // document.head.appendChild(linkEl);  zy 1125
  ...
  newNode.className = 'content';  //zy 1125
  newNode.id = 'content';
  ...
  if (!navbarEl && titleEl) {
    newNode.innerHTML = '<div class="navbar-inner"> <div class="content"> <div id="headline" class="brand"> </div> </div> </div>';
